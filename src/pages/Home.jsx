        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
              Founded in 2020, Nico Farms is committed to responsible poultry farming
              with a focus on quality products and animal welfare. We believe in the
              power of farming done right, where the welfare of our animals and the
              quality of our products always come first.
            </p>
            <Link to="/about">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mt-16">
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Premium eggs and chicken from healthy, well-cared birds raised with the highest standards.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Sustainable methods that prioritize animal welfare and environmental responsibility.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Proper nutrition and care for superior quality products you can trust.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
              ...
              <p className="text-gray-600 leading-relaxed">
                Reliable supplier to restaurants, bakeries, retailers, and food service providers.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg text-gray-700 leading-relaxed">
              We prioritise animal welfare, balanced nutrition for our birds, and
              sustainable agricultural practices to deliver quality products. Our
              commitment to responsible farming ensures that every egg and chicken
              meets the highest standards of quality and nutrition.
            </p>
      ...
      <section className="px-6 md:px-16 py-20 bg-gradient-to-r from-green-800 to-green-900 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl mb-8 leading-relaxed opacity-90">
            Nico Farms continues to expand operations and welcomes investors and strategic partners.
            Join us in building a sustainable future through responsible farming.
          </p>
          <Link to="/investors">
      ...
      <section className="px-6 md:px-16 py-20 bg-gradient-to-br from-yellow-50 to-orange-50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-700 mb-8 leading-relaxed">
            Contact us today to discuss your poultry product needs. We're here to serve
            your business with quality, fresh products.
          </p>

...
`,
  ...
  },
  {
    ...
    bio: "Adewole Saidi Abiola is a poultry veterinary specialist and farm consultant with a strong focus on animal health, nutrition and sustainable poultry production.",
    specialties: [
    ...
    about: `Adewole Saidi Abiola is a poultry veterinary specialist and farm consultant with a strong focus on animal health, nutrition and sustainable poultry production.
...
At Nico AgriFarms, Abiola provides expert guidance on nutrition, biosecurity and overall farm health management, ensuring that the farm maintains high standards in animal welfare and product quality. His hands-on approach supports the development of efficient feeding systems, disease control strategies and best practices in poultry care.

Driven by a commitment to excellence, Abiola works to promote safe, healthy poultry production while supporting the growth of sustainable farming systems. His work continues to contribute to improved farm outcomes through professionalism, innovation and quality-driven management.
